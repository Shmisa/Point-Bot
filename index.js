...
async function updateLeaderboard() {
  ...
  try {
    ...
    console.error('🛑 Failed to send/update leaderboard message:', err);
  }
...
async function handleProgress(message, parts) {
  ...
  // Add this function with your other command handlers (after handleTakePoints)
...
// Handle graceful shutdown on Replit
